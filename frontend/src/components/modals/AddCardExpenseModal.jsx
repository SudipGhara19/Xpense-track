...
function AddCardExpenseModal({ showModal, setShowModal }) {
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (!description || !amount || (!category && !customCategory) || !cardNumber || !cardHolderName) {
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-70 z-50">
      <div className="bg-white p-6 rounded-lg w-[90%] max-w-md shadow-lg relative">
        ...
        <div className="space-y-3">
          ...
          {/* Custom Category Input (Only If "Others" is Selected) */}
          {category === "Others" && (
            <input
              type="text"
